...
class Network {
 private:
  ...
  static void exchange_frames(const string &x_name, AsyncNetworkInterface &x, const string &y_name,
                              AsyncNetworkInterface &y, const string &z_name,
  ...
  static void deliver(const string &src_name, AsyncNetworkInterface &src, const string &dst1_name,
                      AsyncNetworkInterface &dst1, const string &dst2_name,
 ...
 public:
  Network()
      : default_id(
        ...
        uun3_id(
            _router.add_interface({random_router_ethernet_address(), Address{"198.178.229.1"}})),
        hs4_id(_router.add_interface({random_router_ethernet_address(), Address{"143.195.0.2"}})),
        mit5_id(
            _router.add_interface({random_router_ethernet_address(), Address{"128.30.76.255"}})) {
  ...
  void simulate_physical_connections() {
    ...
    exchange_frames("router.uun3", _router.interface(uun3_id), "dm42", host("dm42").interface(),
                    "dm43", host("dm43").interface());
  }
