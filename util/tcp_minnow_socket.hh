...
class TCPMinnowSocket : public LocalStreamSocket {
 ...
 private:
  ...
  std::atomic_bool _abort{
      false};  //!< Flag used by the owner to force the TCPPeer thread to shut down
...
//! Helper class that makes a TCPOverIPv4overEthernetMinnowSocket behave more like a (kernel)
//! TCPSocket
